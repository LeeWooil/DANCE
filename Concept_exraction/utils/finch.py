...
def req_numclust(c, data, req_clust, distance, use_ann_above_samples, verbose):
    ...
    for i in range(iter_):
        adj, orig_dist = clust_rank(mat, use_ann_above_samples, initial_rank=None, distance=distance, verbose=verbose,seed=655)
...
def FINCH(
        ...
        verbose=True,
        use_ann_above_samples=70000,seed=None):
    ...
    while exit_clust > 1:
        adj, orig_dist = clust_rank(mat, use_ann_above_samples, initial_rank, distance, verbose,seed)
