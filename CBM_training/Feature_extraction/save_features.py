import torch
import random
import CBM_training.utils.data_utils as data_utils
import argparse
import numpy as np
from torch.utils.data import DataLoader
from video_dataloader import video_utils
from CBM_training.utils.cbm_utils import *
from video_dataloader import datasets
from CBM_training.model.modeling_clip import CLIP
...
parser.add_argument('--data_set', default='Kinetics-400', choices=['kth','kth-5','kth-2','penn-action','penn-action_adding_class','haa100','kinetics100','kinetics400','kinetics400_scratch', 'mini-SSV2','SSV2', 'UCF101','UCF100', 'HMDB51','image_folder'],
