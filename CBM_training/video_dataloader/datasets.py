...
from CBM_training.model.transforms import *
...
def build_dataset(is_train, test_mode, args):
    if args.data_set == 'kinetics400':
        ...
        dataset = SSVideoClsDataset(
            ...
            args=args)
        nb_classes = 15
    elif args.data_set == 'penn-action_adding_class':
        mode = None
        anno_path = None
        if is_train is True:
            mode = 'validation'
        ...
        dataset = UCF101_SCUBA(
            ...
            args=args)
        nb_classes = 101
    elif args.data_set == 'UCF101' or args.data_set == 'UCF101_mimetics' :
        mode = None
        anno_path = None
        if is_train is True:
            mode = 'validation'
